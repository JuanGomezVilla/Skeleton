...
class ContextDB {
    ...
    function __construct($host = "", $user = "", $password = ""){
        ...
        try {
            ...
            //Prevents values ​​from not being converted correctly
    ...
    public function fetch_single_value($text, $arguments = null, $type_fetch = PDO::FETCH_ASSOC){
        //If there is a connection to the database
        if($this->connection != null){
            //Try to run the query
            try {
